...
public class EpeDbEntity implements Serializable {
	...
	private EpeDbEntity(boolean insert, EpeDbMetaDataEntity metaData, Map<String, Object> mapAttAndValue, List<String> listAttUpdated) throws EpeAppException {
		this.insert = insert;
		this.metaData = metaData;
		this.mapAttAndValue = this.retrieveMapAttAndValueNorm(mapAttAndValue);
	...
	public Integer getInteger(String attribute) throws EpeAppException {
		return this.getWithType(attribute, Integer.class);
	}
	...
	public String getToString(String attribute) throws EpeAppException {
		return this.getToString(attribute, EpeAppConstants.TIMESTAMP_DEFAULT_FORMAT);
	}

	/**
	 * The type of the value gets converted to String. Null becomes "".
	 */
	public String getToString(String attribute, String format) throws EpeAppException {
		...
		if (value == null) {
			...
			String dateStr = EpeAppUtils.retrieveTimestamp(format, (Timestamp) value);
			return dateStr;
		} else {
	...
	public static String getToStringAsVarcharOrNull(String value) throws EpeAppException {
		return value == null ? null : getToStringAsVarchar(value);
	}
	...
	private String retrieveDescriptionShortOrLong(boolean shortDescr, String descriptionTemplate, String descriptionColumns) throws EpeAppException {
	...
	public String retrieveDescriptionShort() throws EpeAppException {
		return this.retrieveDescriptionShortOrLong(true, EpeDbEntityColumns.DESCR_SHORT_TEMPL, EpeDbEntityColumns.DESCR_SHORT_COLS);
	}

	public String retrieveDescriptionLong() throws EpeAppException {
		return this.retrieveDescriptionShortOrLong(false, EpeDbEntityColumns.DESCR_LONG_TEMPL, EpeDbEntityColumns.DESCR_LONG_COLS);
	}
	...
	public String retrieveUpdate() throws EpeAppException {
		...
		for (String col : this.listAttUpdated) {
			...
			sb.append(col);
			sb.append(" = ");
			sb.append(col.equals(EpeAppConstants.COL_UPDATED) ? this.getToStringForDb(col, new Timestamp(new Date().getTime())) : this.getToStringForDb(col));
		}
