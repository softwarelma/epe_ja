...
public final class EpeDiskFinalList_files extends EpeDiskAbstract {
	...
	public static final String PROP_SUFFIX_NO_EXTENSION = "suffixNoExtension";

	@Override
	public EpeExecResult doFunc(EpeExecParams execParams, List<EpeExecResult> listExecResult) throws EpeAppException {
		String postMessage = "list_files, expected dir name and optionally one or more of the following params "
				+ "in any order and respecting the keys of the properties:\n\"" + PROP_PREFIX + "=some prefix\", " + "\"" + PROP_CONTAINED
				+ "=some contained string\", \"" + PROP_SUFFIX + "=some suffix\", \"" + PROP_SUFFIX_NO_EXTENSION + "=some suffix without extension\".";
		...
		String prefixContainedOrSuffix4 = getStringAt(listExecResult, 4, postMessage, null);
		List<String> list = listFiles(dirName, prefixContainedOrSuffix1, prefixContainedOrSuffix2, prefixContainedOrSuffix3, prefixContainedOrSuffix4);
		log(execParams, list);
	...
	public static List<String> listFiles(String dirName, String prefixContainedOrSuffix1, String prefixContainedOrSuffix2, String prefixContainedOrSuffix3)
			throws EpeAppException {
		String[] prefixContainedAndSuffix = retrievePrefixContainedAndSuffix(prefixContainedOrSuffix1, prefixContainedOrSuffix2, prefixContainedOrSuffix3);
		return listFiles(dirName, prefixContainedAndSuffix);
	}

	public static List<String> listFiles(String dirName, String prefixContainedOrSuffix1, String prefixContainedOrSuffix2, String prefixContainedOrSuffix3,
			String prefixContainedOrSuffix4) throws EpeAppException {
		String[] prefixContainedAndSuffix = retrievePrefixContainedAndSuffix(prefixContainedOrSuffix1, prefixContainedOrSuffix2, prefixContainedOrSuffix3,
				prefixContainedOrSuffix4);
		return listFiles(dirName, prefixContainedAndSuffix);
	}

	public static boolean isValidFileOrDir(String dirOrFileName, String[] prefixContainedAndSuffix) throws EpeAppException {
		EpeAppUtils.checkNull("dirOrFileName", dirOrFileName);
		dirOrFileName = EpeAppUtils.cleanFilename(dirOrFileName);
		dirOrFileName = dirOrFileName.endsWith("/") ? dirOrFileName.substring(0, dirOrFileName.length() - 1) : dirOrFileName;
		...
		String suffixNoExtension = prefixContainedAndSuffix.length > 3 ? prefixContainedAndSuffix[3] : null;
	...
	public static String[] retrievePrefixContainedAndSuffix(String str1, String str2, String str3) throws EpeAppException {
	...
	public static String[] retrievePrefixContainedAndSuffix(String str1, String str2, String str3, String str4) throws EpeAppException {
		String[] prefixContainedAndSuffix = { null, null, null, null };
		retrievePrefixContainedOrSuffixByStr(str1, prefixContainedAndSuffix);
		retrievePrefixContainedOrSuffixByStr(str2, prefixContainedAndSuffix);
		retrievePrefixContainedOrSuffixByStr(str3, prefixContainedAndSuffix);
		retrievePrefixContainedOrSuffixByStr(str4, prefixContainedAndSuffix);
		return prefixContainedAndSuffix;
	}

	private static void retrievePrefixContainedOrSuffixByStr(String str, String[] prefixContainedAndSuffix) throws EpeAppException {
		...
		} else if (filePathAndLast.getKey().equals(PROP_SUFFIX_NO_EXTENSION)) {
			prefixContainedAndSuffix[3] = filePathAndLast.getValue();
		} else {
