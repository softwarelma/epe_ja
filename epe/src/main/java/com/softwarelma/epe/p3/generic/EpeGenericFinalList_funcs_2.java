...
public final class EpeGenericFinalList_funcs_2 extends EpeGenericAbstract {
    ...
    public EpeExecResult doFunc(EpeExecParams execParams, List<EpeExecResult> listExecResult) throws EpeAppException {
        ...
        List<String> listFunc = null;
        try {
            List<Class<?>> list = getClassesForPackage("com.softwarelma.epe.p3.generic");
